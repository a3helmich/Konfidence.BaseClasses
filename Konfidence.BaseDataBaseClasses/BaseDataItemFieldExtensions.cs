...
namespace Konfidence.BaseData
{
    public static class BaseDataItemFieldExtensions
    {
        ...
        public static void SetField([NotNull] this BaseDataItem baseDataItem, string fieldName, byte value)
        {
            baseDataItem.SpParameterData.SetParameter(fieldName, value);
        }
        ...
        public static void SetField([NotNull] this BaseDataItem baseDataItem, string fieldName, long value)
        {
            baseDataItem.SpParameterData.SetParameter(fieldName, value);
        }

        public static void SetField([NotNull] this BaseDataItem baseDataItem, string fieldName, Guid value)
        {
            baseDataItem.SpParameterData.SetParameter(fieldName, value);
        }

        public static void SetField([NotNull] this BaseDataItem baseDataItem, string fieldName, string value)
        {
            baseDataItem.SpParameterData.SetParameter(fieldName, value);
        }

        public static void SetField([NotNull] this BaseDataItem baseDataItem, string fieldName, bool value)
        {
            baseDataItem.SpParameterData.SetParameter(fieldName, value);
        }
