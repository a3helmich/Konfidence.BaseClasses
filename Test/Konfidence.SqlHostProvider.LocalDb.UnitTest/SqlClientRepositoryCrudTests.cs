...
/// <summary>
/// Covers the stored-procedure execution paths of <see cref="SqlClientRepository"/> against the LocalDB
/// TestClassGenerator snapshot. These are the save/get/get-by/get-list/delete round trips, plus the
