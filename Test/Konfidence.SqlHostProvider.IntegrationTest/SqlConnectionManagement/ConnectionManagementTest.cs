...
public class ConnectionManagementTest
{
    ...
    public void CopySqlSecurityToClientConfig_WithNoMatchingServer_LeavesConnectionUnchanged()
    {
        ...
        // This covers the environment-driven entry point end to end; the file handling itself is tested
        // deterministically against a fixture path in the UnitTest project's ConnectionManagementTests.
