...
namespace Konfidence.BaseDatabaseClasses.Integration.Tests
{
    ...
    public class BaseDataItemTest
    {
        ...
        {
            // arrange
            Dl.TestIntDataItem? testIntDataItem = new Dl.TestIntDataItem
            {
                testTinyInt = 111, 
                testInt = 1111, 
                testBigInt = 11111
            ...
            // act
            Dl.TestIntDataItem? copyTestIntDataItem = new Dl.TestIntDataItem(testIntDataItem.GetId());
        ...
        public void When_TestIntDataItem_is_Created_and_updated_when_queried_should_be_returned_and_updated()
        {
            ...
            // act
            Dl.TestIntDataItem? updateTestIntDataItem = new Dl.TestIntDataItem(testIntDataItem.GetId());
        ...
        public void When_TestIntDataItem_is_Created_and_updated_when_queried_should_return_guidFields()
        {
            ...
            // act
            Dl.TestIntDataItem? updateTestIntDataItem = new Dl.TestIntDataItem(testIntDataItem.GetId());
            Dl.TestIntDataItem? updateTestIntGuidDataItem = new Dl.TestIntDataItem(updateTestIntDataItem.TestIntId);
