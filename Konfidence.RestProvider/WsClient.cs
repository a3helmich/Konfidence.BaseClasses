...
//            {
//                var parameterObject = new DbParameterObject { ParameterName = parameterDataItem.ParameterName, Value = parameterDataItem.Value };
...
//                {
//                    if (parameterObjectItem.ParameterName.Equals("BaseDataItem_KeyValue"))
//                    {
//                        baseDataItem.SetId((int)parameterObjectItem.Value);
//                    }
//                    else
//                    {
//                        parameterDictionary.Add(parameterObjectItem.ParameterName, parameterObjectItem.Value);
//                    }
//                }
